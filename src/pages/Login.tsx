...
export default function Login() {
  ...
  const handleCustomLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.success) {
        setErrorMessage(res.message || 'Akun belum terdaftar. Silakan lakukan pendaftaran akun (Sign Up) terlebih dahulu.');
        return;
      }
      ...
      setIsLoading(false);
      setErrorMessage('Terjadi kendala saat proses masuk. Coba sesaat lagi.');
    }
  };
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (!name.trim() || !regEmail.trim()) {
      setErrorMessage('Lengkapi nama lengkap dan email Anda');
      return;
    }
  ...
  return (
    <div className="h-[100dvh] max-h-[100dvh] w-full bg-[#FDFBF7] dark:bg-slate-950 text-slate-800 dark:text-slate-100 flex flex-col overflow-hidden select-none transition-colors duration-300 relative">
      ...
      <main className="flex-1 h-[calc(100dvh-3.5rem)] w-full flex items-center justify-center p-2 sm:p-4 lg:p-6 overflow-hidden">
        ...
        {/* Unified Modern Glassmorphic Container with Animated Layout Swapping */}
        <motion.div 
          layout
          transition={{ type: 'spring', stiffness: 260, damping: 28 }}
          className={`w-full max-w-5xl h-full max-h-[calc(100dvh-4.5rem)] bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-2xl shadow-emerald-950/5 dark:shadow-black/40 flex overflow-hidden ${
            authMode === 'signup' ? 'flex-col md:flex-row-reverse' : 'flex-col md:flex-row'
          }`}
        >
          
          {/* ======================= HERO INFO PANEL (Swaps Position Smoothly) ======================= */}
          <motion.div 
            layout
            transition={{ type: 'spring', stiffness: 260, damping: 28 }}
            className={`hidden md:flex md:w-5/12 h-full p-6 lg:p-8 text-white relative overflow-hidden flex-col justify-between shrink-0 transition-colors duration-500 ${
              authMode === 'signup' 
                ? 'bg-gradient-to-bl from-teal-900 via-emerald-950 to-slate-950 border-l border-emerald-500/20' 
                : 'bg-gradient-to-br from-emerald-800 via-teal-900 to-slate-950 border-r border-emerald-500/20'
            }`}
          >
            ...
            <div className="pt-3 border-t border-white/15 relative z-10 flex items-center justify-between">
              ...
              <button
                ...
                className="px-3.5 py-1.5 rounded-full bg-white text-slate-900 hover:bg-emerald-50 text-xs font-black transition-all active:scale-95 shadow-md flex items-center gap-1.5 cursor-pointer hover:scale-105"
              >
          ...
          {/* ======================= INTERACTIVE FORM PANEL (Swaps Position Smoothly) ======================= */}
          <motion.div 
            layout
            transition={{ type: 'spring', stiffness: 260, damping: 28 }}
            className="w-full md:w-7/12 h-full p-4 sm:p-6 lg:p-8 flex flex-col justify-between overflow-y-auto sm:overflow-hidden relative hide-scrollbar"
          >
            
            {/* Top Smooth Pill Switcher (Masuk vs Daftar) & Circle Buka Aplikasi */}
            <div className="w-full flex items-center justify-between gap-3 shrink-0 mb-2">
              ...
              {/* Instant Circle Fast-Entry "Buka Aplikasi" */}
              <Link
                to="/app"
                onClick={() => {
                  soundFx.playSuccess();
                ...
                className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-300 dark:border-emerald-800/80 text-emerald-800 dark:text-emerald-300 hover:bg-emerald-100 dark:hover:bg-emerald-900/60 transition-all text-xs font-bold shadow-2xs group cursor-pointer hover:scale-105"
                    ...
                    {loginSubTab === 'demo' && (
                      <div className="space-y-1.5">
                        <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider block">
                          Pilih Akun Demo untuk Akses Langsung:
                        </span>
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full pl-10 pr-4 py-2.5 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-medium text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 shadow-2xs"
                            />
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              placeholder="••••••••"
                              className="w-full pl-10 pr-10 py-2.5 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-medium text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 shadow-2xs"
                            />
                            <button
                              type="button"
                  ...
                  >
                    ...
                    <form onSubmit={handleRegister} className="space-y-2.5">
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full pl-10 pr-3.5 py-2 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-medium text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 shadow-2xs"
                            />
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <select
                              ...
                              className="w-full pl-10 pr-3 py-2 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-medium text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 shadow-2xs cursor-pointer truncate"
                            >
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full pl-10 pr-4 py-2 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-medium text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 shadow-2xs"
                            />
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full pl-10 pr-10 py-2 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-medium text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 shadow-2xs"
                            />
                            <button
                              type="button"
                              onClick={() => setShowPassword(!showPassword)}
                      ...
                      <div className="pt-1 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                        ...
                        {/* Minimalist Centered Circle Action Button: Daftar & Mulai */}
                        <button
                          type="submit"
                          disabled={isLoading}
                          className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-6 py-2.5 rounded-full bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-bold text-xs uppercase tracking-wider shadow-md shadow-emerald-700/20 hover:shadow-emerald-700/40 hover:scale-[1.02] active:scale-95 transition-all group cursor-pointer disabled:opacity-50 shrink-0"
                        >
