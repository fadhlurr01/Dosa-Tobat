    ...
    >
      ...
      <div className="grid grid-cols-2 gap-3.5 sm:gap-4">
        ...
        <motion.div whileHover={{ y: -3, scale: 1.01 }} whileTap={{ scale: 0.97 }}>
          ...
          >
            <div className="absolute -right-4 -bottom-4 opacity-5 group-hover:scale-110 transition-transform">
              <Compass className="w-20 h-20 text-emerald-600" />
            </div>
            <div className="bg-emerald-50 dark:bg-emerald-500/10 p-3 rounded-2xl mb-2 group-hover:scale-110 transition-transform">
              <Compass className="w-6 h-6 text-emerald-600 dark:text-emerald-400" />
            </div>
            <div>
              <span className="text-xs font-bold text-emerald-800 dark:text-emerald-300 uppercase tracking-wide block">Panduan Taubat</span>
        ...
        <motion.div whileHover={{ y: -3, scale: 1.01 }} whileTap={{ scale: 0.97 }}>
          ...
          >
            <div className="absolute -right-4 -bottom-4 opacity-5 group-hover:scale-110 transition-transform">
              <CircleDot className="w-20 h-20 text-emerald-600" />
            </div>
            <div className="bg-emerald-50 dark:bg-emerald-500/10 p-3 rounded-2xl mb-2 group-hover:scale-110 transition-transform">
              <CircleDot className="w-6 h-6 text-emerald-600 dark:text-emerald-400" />
            </div>
            <div>
              <span className="text-xs font-bold text-emerald-800 dark:text-emerald-300 uppercase tracking-wide block">Tasbih & Dzikir</span>
