...
Route::prefix('v1')->group(function () {
    ...
    // Admin User & Platform Management Routes (Accessible by Admin Panel)
    Route::get('/admin/users', [AdminUserController::class, 'index']);
    Route::put('/admin/users/{id}', [AdminUserController::class, 'update']);
    Route::delete('/admin/users/{id}', [AdminUserController::class, 'destroy']);
    Route::patch('/admin/users/{id}/status', [AdminUserController::class, 'updateStatus']);
    Route::get('/admin/backup', [AdminUserController::class, 'backup']);
    Route::post('/admin/restore', [AdminUserController::class, 'restore']);
    Route::post('/admin/reset', [AdminUserController::class, 'reset']);

    // Public Master Data & Feedback
    ...
    Route::post('/feedback', function (Request $request) {
        ...
        return response()->json([
            'success' => true,
            'message' => 'Jazakallahu khairan! Feedback Anda telah kami terima untuk pengembangan aplikasi.',
        ]);
    });
